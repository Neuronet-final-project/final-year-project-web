...
export function StatCards({
  ...
  return (
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mt-8">
      {/* 1. Active Alerts */}
      <div className="group relative overflow-hidden rounded-[2rem] border border-white/40 bg-white/80 backdrop-blur-md p-6 shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_20px_40px_rgb(239,68,68,0.15)] hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="relative mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-red-50 to-orange-50 text-red-500 shadow-sm transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
      ...
      <div className="group relative overflow-hidden rounded-[2rem] border border-white/40 bg-white/80 backdrop-blur-md p-6 shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_20px_40px_rgb(16,185,129,0.15)] hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="relative mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-50 to-green-50 text-emerald-500 shadow-sm transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3">
      ...
      {/* 3. Unread Messages */}
      <Link href="/counselor/chat" className="group relative overflow-hidden rounded-[2rem] border border-white/40 bg-white/80 backdrop-blur-md p-6 shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_20px_40px_rgb(59,130,246,0.15)] hover:-translate-y-1 transition-all duration-300 block">
        ...
        <div className="relative mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-50 to-cyan-50 text-blue-500 shadow-sm transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
        ...
        <p className="relative mt-1 text-sm font-semibold text-zinc-500">Total Conversations</p>
      </Link>

      {/* 4. Active Channels */}
      <Link href="/counselor/chat" className="group relative overflow-hidden rounded-[2rem] border border-white/40 bg-white/80 backdrop-blur-md p-6 shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_20px_40px_rgb(168,85,247,0.15)] hover:-translate-y-1 transition-all duration-300 block">
        ...
        <div className="relative mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-50 to-fuchsia-50 text-purple-500 shadow-sm transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3">
