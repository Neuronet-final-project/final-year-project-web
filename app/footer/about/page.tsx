        ...
        <section className="py-24 bg-white">
          <div className="mx-auto max-w-7xl px-5 md:px-8">
            ...
            <div className="rounded-3xl bg-gradient-to-br from-indigo-50 to-cyan-50 p-12 border border-indigo-100 text-center">
              ...
              <a href="/footer/contact" className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-indigo-600 to-cyan-500 px-8 py-4 text-lg font-black text-white hover:shadow-xl hover:shadow-indigo-500/30 transition-all">
                Get in touch
              </a>
            </div>
          </div>
